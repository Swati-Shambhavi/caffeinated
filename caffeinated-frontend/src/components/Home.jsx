  ...
  return (
    <>
      <div className="text-amber-50 relative overflow-hidden h-screen">
        ...
        <div
          className="absolute inset-0 bg-black opacity-50 filter blur-md"
          style={{ zIndex: 1 }}
        ></div>
      ...
      <div className="flex flex-wrap bg-amber-50 p-8">
        <section className="w-full sm:w-1/2 md:w-1/2 lg:w-1/3 xl:w-1/3 p-4">
          <div className="flex items-center">
            <div><FaPalette size={28} /></div>
            <h2 className="ml-2 font-kalnia text-2xl">Exquisitely curated.</h2>
          </div>
          <p className="pr-3 font-sans">Indulge in flavors from around the world, meticulously crafted in your neighborhood for a delightful experience.</p>
        </section>
        <section className="w-full sm:w-1/2 md:w-1/2 lg:w-1/3 xl:w-1/3 p-4">
          <div className="flex items-center">
            <div><FaMugHot size={28} /></div>
            <h2 className="ml-2 font-kalnia text-2xl">Contemporary Coffee.</h2>
          </div>
          <p className="pr-3 font-sans">Embark on a journey of modern coffee, where every sip is a celebration of ethical and holistic brewing methods.</p>
        </section>
        <section className="w-full sm:w-1/2 md:w-1/2 lg:w-1/3 xl:w-1/3 p-4">
          <div className="flex items-center">
            <div><FaCube size={28} /></div>
            <h2 className="ml-2 font-kalnia text-2xl">Distinctive brews.</h2>
          </div>
          <p className="pr-3 font-sans">Discover our sixteen distinct blends, each house offering a unique and unparalleled coffee experience. No two cups are the same!</p>
        </section>
      </div>
      <div>
